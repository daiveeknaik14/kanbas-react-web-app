...
function AssignmentEditor() {
  ...
  const handleSave = () => {
    if (
      ...
      assignment.availableFromDate == null ||
      assignment.availableUntilDate == null ||
      assignment.title?.length == 0
    ) {
      alert("Please Complete all input!");
      return;
    }
    client.updateAssignment(assignment).then((a) => {
  ...
  return (
    <form>
      <div className="form-group" style={{ width: "80%" }}>
        ...
        <h6>
          <label className="" for="assignmentTitle">
            Assignment Title
          </label>
        </h6>
        <input
        ...
        />
        <h6>
          <label className="" for="assignmentDescription">
            Assignment Title
          </label>
        </h6>
        <textarea
        ...
        />
        <h6>
          <label className="" for="assignmentPoints">
            Points
          </label>
        </h6>
        <input
        ...
        <h6>
          <label for="assignmentDueDate">Due</label>
        </h6>
        <input
        ...
        <div>
          <div class="row">
            <div class="col">
              <h6>
                <label for="assignmentAvailableFromDate">Avaliable From</label>
              </h6>
            </div>
            <div class="col">
              <h6>
                <label for="assignmentAvailableUntilDate">Untill</label>
              </h6>
            </div>
          </div>
          <div class="row">
